...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$texto = $_POST['texto'];
	$thumb = $_FILES['thumb']['tmp_name'];// tmp_name es un valor de un archivo temporal que es almacenado en la carpeta propia de xampp
...
// prueba echo $_FILES['thumb']['name'] . '    ' . $_FILES['thumb']['tmp_name'] . '     '. 	$archivo_subido;
