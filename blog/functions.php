...
function id_articulo($id){// que solo sea un numero el que se reconozca
...
function fecha($fecha){
	$timestamp = strtotime($fecha);// srttotime nos sirve para mas adelante poder descomponer la fecha
